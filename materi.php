    ...
    <main class="max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row gap-6">
      ...
      <section class="flex-1">
        ...
        <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
          ...
          <!-- Tombol Unduh -->
          <div class="flex">
            <a href="#" class="inline-flex items-center px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded hover:bg-purple-700 transition">
              📄 Download file_materi.docx
            </a>
          </div>
        </div>
