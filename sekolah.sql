...
--
-- Host: localhost:3306
-- Generation Time: Feb 24, 2026 at 02:34 AM
...
(8, 7, 'kirk', '9A', 'ef797c8118f02dfb649607dd5d3f8c7623048c9c063d532cc95c5ed7a898a64f', 'alpa', 67, 'attack helicopter', '1764551588_syahid pocong.jpg', NULL, NULL, NULL, 'aktif', '2025-12-01 06:45:46', NULL, NULL),
...
--
ALTER TABLE `nilai_pretest`
  MODIFY `id_nilai` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;
...
--
ALTER TABLE `progress_tracking`
  MODIFY `id_progress` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=94;
