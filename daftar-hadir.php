          ...
          <table class="w-full table-auto border-collapse">
            <thead>
              <tr class="bg-purple-100 text-purple-700">
                ...
                <th class="border px-4 py-2 text-center">Alfa</th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="border px-4 py-2 text-center">
                  <input type="radio" name="siswa1_status" value="hadir">
                </td>
                <td class="border px-4 py-2 text-center">
                  <input type="radio" name="siswa1_status" value="izin">
                </td>
                <td class="border px-4 py-2 text-center">
                  <input type="radio" name="siswa1_status" value="alpa">
                </td>
                <td class="border px-4 py-2 text-center">
                  <input type="text" name="siswa1_keterangan" placeholder="Alasan jika tidak hadir" class="w-full px-2 py-1 border rounded text-sm">
                </td>
              </tr>
