        ...
        <div class="bg-white rounded-lg shadow-md p-6 border border-gray-200">
          ...
          <form class="space-y-6">
            ...
            <div class="bg-gray-50 border border-gray-300 rounded-md p-4">
              ...
              <input type="textarea" name="soal" id="soal" placeholder="Soal" class="py-2 px-4 m-1 w-full rounded-md border-2">

              <div class="space-y-2 text-sm text-gray-700">
                <label class="flex items-center space-x-2">
                  <input type="radio" name="soal1" value="a" class="text-purple-600 focus:ring-purple-500">
                  <span><input type="text" class="py-1 px-2 rounded-md border-2" placeholder="section"></span>
                </label>
                <label class="flex items-center space-x-2">
                  <input type="radio" name="soal1" value="a" class="text-purple-600 focus:ring-purple-500">
                  <span><input type="text" class="py-1 px-2 rounded-md border-2" placeholder="section"></span>
