      ...
      <section class="flex-1">
        ...
        <div id="mapelContainer" class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div class="flex items-center justify-between mb-3">
              <div class="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p class="text-sm text-gray-600">Guru: Nama Guru</p>
                </div>
              </div>
          ...
          <div class="border border-gray-300 rounded-xl p-4 bg-white flex flex-col shadow-sm hover:shadow-md transition">
            <div class="flex items-center justify-between mb-3">
              <div class="flex items-center gap-3">
                ...
                <div>
                  <p class="font-semibold text-gray-800">IPAS</p>
                  <p class="text-sm text-gray-600">Guru: Nama Guru</p>
                </div>
              </div>
              <button class="text-sm text-blue-600 hover:underline">Edit</button>
          ...
          <div class="border border-gray-300 rounded-xl p-4 bg-white flex flex-col shadow-sm hover:shadow-md transition">
            <div class="flex items-center justify-between mb-3">
              <div class="flex items-center gap-3">
                <div class="bg-pink-500 w-10 h-10 rounded-lg flex items-center justify-center text-white font-bold text-lg">📘</div>
                <div>
          ...
          <div class="border border-gray-300 rounded-xl p-4 bg-white flex flex-col shadow-sm hover:shadow-md transition">
            <div class="flex items-center justify-between mb-3">
              <div class="flex items-center gap-3">
                <div class="bg-green-500 w-10 h-10 rounded-lg flex items-center justify-center text-white font-bold text-lg">📘</div>
                <div>
          ...
          <div class="border border-gray-300 rounded-xl p-4 bg-white flex flex-col shadow-sm hover:shadow-md transition">
            <div class="flex items-center justify-between mb-3">
              <div class="flex items-center gap-3">
                <div class="bg-blue-500 w-10 h-10 rounded-lg flex items-center justify-center text-white font-bold text-lg">📘</div>
                <div>
                  <p class="font-semibold text-gray-800">PP</p>
                  <p class="text-sm text-gray-600">Guru: Nama Guru</p>
                </div>
              </div>
              <button class="text-sm text-blue-600 hover:underline">Edit</button>
          ...
          <!-- Card "+" -->
          <div
            class="flex items-center justify-center border border-dashed border-gray-300 rounded-xl text-gray-400 text-4xl bg-white cursor-default">
            +
          </div>
        </div>
      </section>
