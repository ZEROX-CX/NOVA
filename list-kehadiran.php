  ...
  <body class="bg-white min-h-screen font-sans text-gray-800">
    ...
    <main class="max-w-7xl mx-auto px-4 py-10 flex flex-col md:flex-row gap-6">
      ...
      <section class="flex-1">
        ...
        <h2 class="text-2xl font-bold text-purple-700 mb-6">Kehadiran Siswa - Pertemuan 1</h2>
        ...
        <div class="max-w-4xl mx-auto bg-white border border-purple-300 rounded-lg shadow-md p-6">
          <table class="w-full table-auto border-collapse">
            ...
            <tbody>
              <!-- Contoh Baris -->
              <tr>
                <td class="border px-4 py-2">Siswa 1</td>
                <td class="border px-4 py-2 text-center text-green-600 font-semibold">Hadir</td>
                <td class="border px-4 py-2 text-center">-</td>
              </tr>
              <tr>
                <td class="border px-4 py-2">Siswa 2</td>
                <td class="border px-4 py-2 text-center text-yellow-600 font-semibold">Izin</td>
                <td class="border px-4 py-2 text-center">Ada keperluan keluarga</td>
              </tr>
              <tr>
                <td class="border px-4 py-2">Siswa 3</td>
                <td class="border px-4 py-2 text-center text-red-600 font-semibold">Alpa</td>
                <td class="border px-4 py-2 text-center">Tidak ada keterangan</td>
              </tr>
