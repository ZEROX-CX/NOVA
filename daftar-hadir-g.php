      ...
      <section class="flex-1">
        ...
        <form class="max-w-3xl mx-auto bg-white border border-purple-300 rounded-lg shadow-md p-6 space-y-6">
          ...
          <table class="w-full table-auto border-collapse">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="border px-4 py-2 text-center"><a href="list-kehadiran.php">Lihat daftar</a></td>
              </tr>
          ...
          <div class="flex justify-end">
            <button type="button" class="w-full px-4 py-2 bg-white text-purple-700 border rounded hover:bg-purple-50 focus:outline-none focus:ring-2 focus:ring-purple-500">
              + Tambah Sesi
            </button>
          </div>
          <!-- Tombol Submit -->
