<?php
// gunakan id dari $data kalau controller mengirimkannya,
// fallback ke $_GET atau segmen terakhir bila perlu
...
<body class="bg-gray-100 font-sans text-gray-800">
  ...
  <div class="flex min-h-screen">
    ...
    <main class="flex-1 p-10">
      <!-- Section Materi -->
               <a class="text-lg text-gray-600 hover:text-purple-600 transition" href="<?= BASEURL ?>/pertemuan_content/<?= $data['id_mapel'] ?>/<?= $data['id_pertemuan'] ?>">
          < Kembali
        </a>
      <section class="bg-white p-8 rounded-lg shadow">
        ...
        <div class="border-t border-gray-200 pt-6">
          <a href="<?= BASEURL ?>/pengumpulan/<?= $tugas['id_tugas']; ?>/<?= $data['pertemuan']['id_pertemuan'] ?>" class="text-center block w-[200px] py-2 px-1 rounded-md bg-blue-600 text-white font-semibold">Kumpulkan Tugas</a>
        </div>
      </section>
    </main>
