...
<body>
    <?php
// views/pretest/create.php
?>

<div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
    <h2 class="text-2xl font-bold mb-6">Tambah Soal Pre-Test Baru</h2>
    <form action="<?= BASEURL ?>/pretest/store" method="post">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="<?= BASEURL ?>/pretest/index/<?= $data['id_pertemuan'] ?>" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
                Batal
            </a>
        </div>
    </form>
