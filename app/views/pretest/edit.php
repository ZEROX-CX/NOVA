...
<body class="bg-gray-50 min-h-screen py-10">
  <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
      <h2 class="text-2xl font-bold mb-6">Edit Soal Pre-Test</h2>
      <form action="<?= BASEURL ?>/pretest/update" method="post">
          <input type="hidden" name="id_pretest" value="<?= $soal['id_pretest'] ?>">
          ...
          <div class="flex items-center justify-between">
              ...
              <a href="<?= BASEURL ?>/pretest/index/<?= $soal['id_pertemuan'] ?>" class="inline-block align-baseline font-bold text-sm text-blue-500 hover:text-blue-800">
                  Batal
              </a>
          </div>
      </form>
