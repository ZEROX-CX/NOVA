...
<aside class="sidebar md:hidden bg-white shadow-lg p-4">
  ...
  <div class="max-w-[900px] w-[400px] lg:w-[900px] mx-auto">
    ...
    <div class="bg-primary text-white text-center py-3 rounded-xl font-semibold text-base mb-4">
      ...
      <form action="<?= BASEURL ?>/linimasa" method="POST" class="flex flex-col md:flex-row items-center gap-2 mb-6">
        <div class="flex items-center border border-primary rounded-lg px-3 py-1 bg-white w-[400px] lg:w-[900px]">
        ...
        <?php foreach ($cek as $t): ?>
          <div class="p-3">
            ...
            <div class="flex gap-3 border-2 border-primary rounded-[15px] p-3 hover:bg-purple-50 transition">
              ...
              <div>
                <div class="">
                   <a href="<?= BASEURL ?>/tugas/<?= $t['id_mapel'] ?>/<?= $t['id_tugas'] ?>" class="font-semibold"><?= $t['judul_tugas'] ?></a>
