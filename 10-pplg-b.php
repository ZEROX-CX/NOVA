      ...
      <section class="flex-1">
        ...
        <div class="p-6 bg-white rounded-lg shadow-md">
          ...
          <div class="mb-4">
            ...
            <h1 class="text-2xl font-bold text-gray-800">Kelas - 10 PPLG B</h1>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <a href="daftar-hadir-g.php">
              <div class="flex items-center justify-between bg-gray-100 p-4 rounded-lg shadow-sm">
                ...
                <button class="text-sm text-purple-600 hover:underline">Edit</button>
              </div>
            </a>
          
            <a href="pre-test-g.php">
              <div class="flex items-center justify-between bg-gray-100 p-4 rounded-lg shadow-sm">
                <div class="flex items-center space-x-3">
                  <div class="bg-purple-600 text-white p-2 rounded-full">📝</div>
